...
#define LOG(...) SPDLOG_LOGGER_INFO(imog::Logger::print(), __VA_ARGS__);
#define LOGD(...) SPDLOG_LOGGER_INFO(imog::Logger::info(), __VA_ARGS__);
#define LOGE(...) SPDLOG_LOGGER_ERROR(imog::Logger::error(), __VA_ARGS__);
